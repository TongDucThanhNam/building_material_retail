import 'package:building_material_retail/models/cart_item.dart';
...
class CartNotifier extends StateNotifier<Map<String, CartItem>> {
  ...
  double get totalAmount {
    ...
    state.forEach((key, cartItem) {
      total += (cartItem.variantChosen.price ?? 0 * cartItem.quantity);
    });
    return total;
  }

  void addItem(String id, Product product, Variant variantChosen) {
